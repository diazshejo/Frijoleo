...
<script type="text/javascript">
    ...
    var strSrcImagenesSrc = 'var strSrcImagenes = [{id: "objImagenFondo", src:"attach/letras/letra-a/fondos/granero.png"},'+
                                '\n{id: "objImagenCuadrado", src:"attach/letras/letra-a/fondos/cuadrado.png"},'+
                                '\n{id: "objImagenRectangulo", src:"attach/letras/letra-a/fondos/rectangulo.png"},'+
                                ...
                                '\n{id: "objImagenAFirst", src:"attach/letras/letra-a/objetos/angel.png"},'+
                                '\n{id: "objImagenASecond", src:"attach/letras/letra-a/objetos/amor.png"},'+
                                '\n{id: "objImagenAThird", src:"attach/letras/letra-a/objetos/alas.png"},'+
                                ...
                                '\n{id: "objImagenASeventh", src:"attach/letras/letra-a/objetos/azul.png"},'+
                                '\n{id: "objImagenAEightieth", src:"attach/letras/letra-a/objetos/agua2.png"},'+
    ...
    arrObjImagenes[9]["texto"] = 'src:"attach/letras/letra-a/objetos/carro.png"},';
    arrObjImagenes[9]["usado"] = false;

    arrObjImagenes[10] = new Array();
    arrObjImagenes[10]["texto"] = 'src:"attach/letras/letra-a/objetos/lonchera.png"},';
    ...
    arrObjImagenesPalabras[1]["texto"] = '';
    ...
    //VARIABLES PARA EL CAMBIO DE JUEGO
    var boolCuadradoOut = boolLetraScaleX = boolLetraScaleY = boolScaleXObjetoA = boolScaleYObjetoA = boolScaleXA = boolScaleYA =  false;
    var intCantBitMapPalabra = 0;
    var boolFirstTieLetraScale = true;
    ...
    function handleFileComplete(event){
        ...
        else if(event.item.id == "objImagenRectangulo"){
            objImagenRectangulo = new Image();
            objImagenRectangulo.src = event.item.src;
        }
    ...
    function handleImageLoad(boolAddLetras) {
        ...
        if(!boolAddLetras){
            ...
            objBitmapCaballo1.y = objCanvas.height - ((objImagenCaballoFirst.height * 1.09) * (intHeight/objImagenFondo.height));
            ...
            objBitmapCaballo2.y = objCanvas.height - ((objImagenCaballoThird.height * 1.09) * (intHeight/objImagenFondo.height));
            ...
            objBitmapCuadrado1.x = objCanvas.width - ((objImagenCuadrado.width * 5.2) * (intWidth/objImagenFondo.width));
            objBitmapCuadrado1.y = objCanvas.height - ((objImagenCuadrado.height * 1.8) * (intHeight/objImagenFondo.height));
            objBitmapCuadrado1.scaleY = (intHeight/objImagenFondo.height);
            objBitmapCuadrado1.scaleX = (intWidth/objImagenFondo.width);
            objContainer.addChild(objBitmapCuadrado1);

            objBitmapCuadrado2 = new createjs.Bitmap(objImagenCuadrado);
            objBitmapCuadrado2.x = objCanvas.width - ((objImagenCuadrado.width * 1.6) * (intWidth/objImagenFondo.width));
            objBitmapCuadrado2.y = objCanvas.height - ((objImagenCuadrado.height * 1.8) * (intHeight/objImagenFondo.height));
            objBitmapCuadrado2.scaleY = (intHeight/objImagenFondo.height);
            objBitmapCuadrado2.scaleX = (intWidth/objImagenFondo.width);
            objContainer.addChild(objBitmapCuadrado2);

            objBitmapRectangulo = new createjs.Bitmap(objImagenRectangulo);
            objBitmapRectangulo.x = objCanvas.width - ((objImagenRectangulo.width * 1.57) * (intWidth/objImagenFondo.width));
            objBitmapRectangulo.y = -1 * (objImagenFondo.height) - 300;
            objBitmapRectangulo.scaleY =  0.8 * (intHeight/objImagenFondo.height);
            objBitmapRectangulo.scaleX = 1 * (intWidth/objImagenFondo.width);
            objContainer.addChild(objBitmapRectangulo);

            objBitmapA = new createjs.Bitmap(arrObjImagenesA[intIdImageA]["objImagen"]);

            objBitmapA.scaleX = (intWidth/objImagenFondo.width) * 0.4;
            objBitmapA.scaleY = (intHeight/objImagenFondo.height) * 0.4;

            objBitmapImagen2 = new createjs.Bitmap(arrObjImagenesA[intIdImageA]["objImagen"]);

            objBitmapImagen2.scaleX = (intWidth/objImagenFondo.width) * 0.4;
            objBitmapImagen2.scaleY = (intHeight/objImagenFondo.height) * 0.4;
            ...
            objBitmapSeguir.y = objCanvas.height - ((objImagenSeguir.height * 1.3 ) * (intHeight/objImagenFondo.height)) - (150 * (intHeight/objImagenFondo.height));
            ...
            objBitmapRegresar.y = objCanvas.height - ((objImagenRegresar.height * 1.55 ) * (intHeight/objImagenFondo.height)) + (150 * (intHeight/objImagenFondo.height));
            ...
            intCantCanvas = arrObjPalabras[intNoClic]["cantidad"];
            arrSplitLetras = arrObjPalabras[intNoClic]["palabra"].split("_");
            var intXPalabra;
            var intXPalabraAnt;
            var intYPalabra;

            intCantBitMapPalabra = 0;
            boolLetraScaleY = boolLetraScaleX = false;
            boolFirstTieLetraScale = true;

            for(i in arrSplitLetras){
                intCantBitMapPalabra++;
                if(arrObjImageLetra[arrSplitLetras[i]] != undefined){
                    if(i == 0){
                        objBitmapPalabra1 = new createjs.Bitmap(arrObjImageLetra[arrSplitLetras[i]]);
                        objBitmapPalabra1.x = intXPalabra = intXPalabraAnt = objCanvas.width - ((arrObjImageLetra[arrSplitLetras[i]].width * 6.5) * (intWidth/objImagenFondo.width));
                        objBitmapPalabra1.y = objCanvas.height - ((arrObjImageLetra[arrSplitLetras[i]].height * 4.2 ) * (intHeight/objImagenFondo.height));
                        objBitmapPalabra1.scaleX = 0.10 * (intWidth/objImagenFondo.width);
                        objBitmapPalabra1.scaleY = 0.10 * (intHeight/objImagenFondo.height);
                        objBitmapPalabra1.type = "palabra";
                        objContainer.addChild(objBitmapPalabra1);

                        if( arrSplitLetras[i].toString() == "a"
                            || arrSplitLetras[i].toString() == "at" ){

                            objBitmapPalabra1.on("click", function (evt) {
                                intNoClic++;
                        ...
                        objBitmapPalabra2 = new createjs.Bitmap(arrObjImageLetra[arrSplitLetras[i]]);

                        if( arrSplitLetras[i-1].toString() == "m"
                            || arrSplitLetras[i-1].toString() == "w" ){

                            if( arrSplitLetras[i].toString() == "m"
                                || arrSplitLetras[i].toString() == "w" ){

                                intXPalabra = intXPalabraAnt = intXPalabraAnt + (135 * (intWidth/objImagenFondo.width));

                            }
                            else if( arrSplitLetras[i].toString() == "f"
                                || arrSplitLetras[i].toString() == "i"
                                || arrSplitLetras[i].toString() == "it"
                                || arrSplitLetras[i].toString() == "j"
                                || arrSplitLetras[i].toString() == "l"
                                || arrSplitLetras[i].toString() == "t"
                                || arrSplitLetras[i].toString() == "r" ){

                                intXPalabra = intXPalabraAnt = intXPalabraAnt + (100 * (intWidth/objImagenFondo.width));

                            }
                            else{

                                intXPalabra = intXPalabraAnt = intXPalabraAnt + (120 * (intWidth/objImagenFondo.width));

                            }


                        }
                        else if( arrSplitLetras[i-1].toString() == "f"
                                || arrSplitLetras[i-1].toString() == "i"
                                || arrSplitLetras[i-1].toString() == "it"
                                || arrSplitLetras[i-1].toString() == "j"
                                || arrSplitLetras[i-1].toString() == "l"
                                || arrSplitLetras[i-1].toString() == "t"
                                || arrSplitLetras[i-1].toString() == "r" ){


                            if( arrSplitLetras[i].toString() == "m"
                                || arrSplitLetras[i].toString() == "w" ){

                                intXPalabra = intXPalabraAnt = intXPalabraAnt + (95 * (intWidth/objImagenFondo.width));
                                ...
                                intXPalabra = intXPalabraAnt = intXPalabraAnt + (40 * (intWidth/objImagenFondo.width));

                            }
                            else{

                                intXPalabra = intXPalabraAnt = intXPalabraAnt + (75 * (intWidth/objImagenFondo.width));
                            ...
                            if( arrSplitLetras[i].toString() == "m"
                                ...
                                intXPalabra = intXPalabraAnt = intXPalabraAnt + (125 * (intWidth/objImagenFondo.width));
                                ...
                                intXPalabra = intXPalabraAnt = intXPalabraAnt + (85 * (intWidth/objImagenFondo.width));

                            }
                            else{

                                intXPalabra = intXPalabraAnt = intXPalabraAnt + (105 * (intWidth/objImagenFondo.width));

                            }
                        }

                        objBitmapPalabra2.x = intXPalabra;
                        objBitmapPalabra2.y = objCanvas.height - ((arrObjImageLetra[arrSplitLetras[i]].height * 4.2 ) * (intHeight/objImagenFondo.height));
                        objBitmapPalabra2.scaleX = 0.10 * (intWidth/objImagenFondo.width);
                        objBitmapPalabra2.scaleY = 0.10 * (intHeight/objImagenFondo.height);
                        objBitmapPalabra2.type = "palabra";
                        objContainer.addChild(objBitmapPalabra2);

                        if( arrSplitLetras[i].toString() == "a"
                            || arrSplitLetras[i].toString() == "at" ){

                            objBitmapPalabra2.on("click", function (evt) {
                                intNoClic++;
                                for( var j = 0; j <= objContainer.numChildren - 1; j++ ) {
                                    var objChild = objContainer.getChildAt(j);
                                    if( objChild.type
                        ...
                        objBitmapPalabra3 = new createjs.Bitmap(arrObjImageLetra[arrSplitLetras[i]]);
                        ...
                        objBitmapPalabra3.x = intXPalabra;
                        objBitmapPalabra3.y = objCanvas.height - ((arrObjImageLetra[arrSplitLetras[i]].height * 4.2 ) * (intHeight/objImagenFondo.height));
                        objBitmapPalabra3.scaleX = 0.10 * (intWidth/objImagenFondo.width);
                        objBitmapPalabra3.scaleY = 0.10 * (intHeight/objImagenFondo.height);
                        objBitmapPalabra3.type = "palabra";
                        objContainer.addChild(objBitmapPalabra3);

                        if( arrSplitLetras[i].toString() == "a"
                            || arrSplitLetras[i].toString() == "at" ){

                            objBitmapPalabra3.on("click", function (evt) {
                                intNoClic++;
                                for( var j = 0; j <= objContainer.numChildren - 1; j++ ) {
                                    var objChild = objContainer.getChildAt(j);
                                    if( objChild.type
                        ...
                        objBitmapPalabra4 = new createjs.Bitmap(arrObjImageLetra[arrSplitLetras[i]]);
                        ...
                        objBitmapPalabra4.x = intXPalabra;
                        objBitmapPalabra4.y = objCanvas.height - ((arrObjImageLetra[arrSplitLetras[i]].height * 4.2 ) * (intHeight/objImagenFondo.height));
                        objBitmapPalabra4.scaleX = 0.10 * (intWidth/objImagenFondo.width);
                        objBitmapPalabra4.scaleY = 0.10 * (intHeight/objImagenFondo.height);
                        objBitmapPalabra4.type = "palabra";
                        objContainer.addChild(objBitmapPalabra4);

                        if( arrSplitLetras[i].toString() == "a"
                            || arrSplitLetras[i].toString() == "at" ){

                            objBitmapPalabra4.on("click", function (evt) {
                                intNoClic++;
                                for( var j = 0; j <= objContainer.numChildren - 1; j++ ) {
                                    var objChild = objContainer.getChildAt(j);
                                    if( objChild.type
                        ...
                        objBitmapPalabra5 = new createjs.Bitmap(arrObjImageLetra[arrSplitLetras[i]]);
                        ...
                        objBitmapPalabra5.x = intXPalabra;
                        objBitmapPalabra5.y = objCanvas.height - ((arrObjImageLetra[arrSplitLetras[i]].height * 4.2 ) * (intHeight/objImagenFondo.height));
                        objBitmapPalabra5.scaleX = 0.10 * (intWidth/objImagenFondo.width);
                        objBitmapPalabra5.scaleY = 0.10 * (intHeight/objImagenFondo.height);
                        objBitmapPalabra5.type = "palabra";
                        objContainer.addChild(objBitmapPalabra5);

                        if( arrSplitLetras[i].toString() == "a"
                            || arrSplitLetras[i].toString() == "at" ){

                            objBitmapPalabra5.on("click", function (evt) {
                                intNoClic++;
                                for( var j = 0; j <= objContainer.numChildren - 1; j++ ) {
                                    var objChild = objContainer.getChildAt(j);
                                    if( objChild.type
                        ...
                        objBitmapPalabra6 = new createjs.Bitmap(arrObjImageLetra[arrSplitLetras[i]]);
                        ...
                        objBitmapPalabra6.x = intXPalabra;
                        objBitmapPalabra6.y = objCanvas.height - ((arrObjImageLetra[arrSplitLetras[i]].height * 4.2 ) * (intHeight/objImagenFondo.height));
                        objBitmapPalabra6.scaleX = 0.10 * (intWidth/objImagenFondo.width);
                        objBitmapPalabra6.scaleY = 0.10 * (intHeight/objImagenFondo.height);
                        objBitmapPalabra6.type = "palabra";
                        objContainer.addChild(objBitmapPalabra6);

                        if( arrSplitLetras[i].toString() == "a"
                            || arrSplitLetras[i].toString() == "at" ){

                            objBitmapPalabra6.on("click", function (evt) {
                                intNoClic++;
                                for( var j = 0; j <= objContainer.numChildren - 1; j++ ) {
                                    var objChild = objContainer.getChildAt(j);
                                    if( objChild.type
    ...
    function tick(event) {
        if(!boolWin1){
            ...
            if(objBitmapCuadrado1.x > -300){
                objBitmapCuadrado1.x = objBitmapCuadrado1.x - (50 * (intWidth/objImagenFondo.width));
            }
            else{
                objBitmapCuadrado1.visible = false;
            }

            if(objBitmapCuadrado2.x < objImagenFondo.width + 300){
                objBitmapCuadrado2.x = objBitmapCuadrado2.x + (50 * (intWidth/objImagenFondo.width));
            }
            else{
                objBitmapCuadrado2.visible = false;
            }

            if(objBitmapRectangulo.y < (objCanvas.height - ((objImagenRectangulo.height * 2.7) * (intHeight/objImagenFondo.height)))){
                objBitmapRectangulo.y = objBitmapRectangulo.y + (50 * (intHeight/objImagenFondo.height));
            }
            else{
                objBitmapRectangulo.y = objCanvas.height - ((objImagenRectangulo.height * 2.7) * (intHeight/objImagenFondo.height));
            }

            if(objBitmapImagen2.scaleY > 0){
                objBitmapImagen2.scaleY = objBitmapImagen2.scaleY * 0.80;
            }
            else{
                boolScaleYObjetoA = true;
            }

            if(objBitmapA.scaleY > 0){
            ...
            if(objBitmapImagen2.scaleX > 0){
                objBitmapImagen2.scaleX = objBitmapImagen2.scaleX * 0.80;
            }
            else{
                boolScaleXObjetoA = true;
            }

            if(objBitmapA.scaleX > 0){
            ...
            if(boolScaleXObjetoA && boolScaleYObjetoA){
                objBitmapImagen2.visible = false;
            }

            if(boolScaleYA && boolScaleXA){
                objBitmapA.visible = false;
            }

            for(var j = 1; j <= intCantBitMapPalabra; j++){
                objBitmapLetraScaleX = eval("objBitmapPalabra"+j+".scaleX");
                objBitmapLetraScaleY = eval("objBitmapPalabra"+j+".scaleY");

                if(objBitmapLetraScaleX < (intWidth/objImagenFondo.width)){
                    eval("objBitmapPalabra"+j+".scaleX = 1.10 * objBitmapPalabra"+j+".scaleX");
                }
                else{
                    boolLetraScaleX = true;
                }

                if(objBitmapLetraScaleY < (intHeight/objImagenFondo.height)){
                    eval("objBitmapPalabra"+j+".scaleY = 1.10 * objBitmapPalabra"+j+".scaleY");
                }
                else{
                    boolLetraScaleY = true;
                }
            }

            if(boolLetraScaleX && boolLetraScaleY){
                if(boolFirstTieLetraScale){
                    boolFirstTieLetraScale = false;
                    for(var j = 1; j <= intCantBitMapPalabra; j++){
                        eval("objBitmapPalabra"+j+".scaleY = intHeight/objImagenFondo.height");
                        eval("objBitmapPalabra"+j+".scaleX = intWidth/objImagenFondo.width");
                        if(intCantBitMapPalabra == 4){
                            eval("objBitmapPalabra"+j+".x = objBitmapPalabra"+j+".x + 20 * (intWidth/objImagenFondo.width)");
                        }
                    }
            ...
            if(objBitmapRectangulo.y > (-1 * (objCanvas.height + (objImagenRectangulo.height))) ){
                objBitmapRectangulo.y = objBitmapRectangulo.y - (50 * (intHeight/objImagenFondo.height));
            }
            else{
                objBitmapRectangulo.visible = false;
            }
        }
    ...
    function fntPosicionLetra(){
        ...
        if(intPosImageA == 1){
            objBitmapA.x = 200 * (intWidth/objImagenFondo.width);
            ...
            objBitmapImagen2.x = 200 * (intWidth/objImagenFondo.width);
            objBitmapImagen2.y = 600 * (intHeight/objImagenFondo.height);
        }
    }
